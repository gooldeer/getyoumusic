...
class FileDownloader(object):
    ...
    def try_rename(self, old_filename, new_filename):
        ...
        # except (UnicodeDecodeError) as err:
            ...
            # print "In errror!"
            # old_filename = old_filename.decode('utf-8')
    ...
    def report_progress(self, percent, data_len_str, speed, eta, callback=None):
    ...
    def _do_download(self, filename, info_dict, callback=None):
        url = info_dict['url']
        ...
        while True:
            ...
            if data_len is None:
                ...
                self.report_progress(percent, data_len_str, speed, eta, callback=callback)
