...
urlpatterns = patterns('',
    ...
    url(r'^playlists/remove/playlist=(?P<playlistName>[\w|\W]+),is_audio=(?P<is_audio>[\w|\W]+)/$', views.remove_playlist, name="remove_playlist"),
    ...
    url(r'^playlists/(?P<playlistName>[\w|\W]+)/audio=(?P<media>[\w|\W]+)/$', views.audio, name="audio"),
